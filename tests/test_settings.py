...
from arches_controlled_lists.settings import *

PACKAGE_NAME = "arches_controlled_lists"
...
TEST_RUNNER = "arches_controlled_lists.test.runner.ArchesControlledListsTestRunner"
